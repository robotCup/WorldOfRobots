...
public class CompetitionController {
	...
	public String CompetitionsFuture(Model model, HttpServletRequest request) {
		...
		model.addAttribute("title", "Comp�titions � venir");
		model.addAttribute("competitions", competitions);
	...
	public String CompetitionsPast(Model model, HttpServletRequest request) {
		...
		model.addAttribute("title", "Comp�titions termin�es");
		model.addAttribute("competitions", competitions);
		session.setAttribute("user", user);
	...
	public String toAdd(@ModelAttribute("add") AddCompetition cardCompetition, Model model,
		...
		if (user == null) {
			...
			try {
				...
				model.addAttribute("message", "L'ajout de votre comp�tition a bien �t� enregistr�e");

			} catch (Exception e) {
				System.out.println(e);
				request.setAttribute("result", false);

				if (e.getMessage().equals("Date incorrect, veuillez saisir une date sup�rieure � celle d'aujourd'hui")){
					model.addAttribute("message", "Date incorrecte, veuillez saisir une date sup�rieure � celle d'aujourd'hui");
				}
				else {
