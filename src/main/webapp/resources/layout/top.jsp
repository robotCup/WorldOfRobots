...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		...
		<ul>
			...
			<li class='has-sub' class="service"> <a href="<%=request.getContextPath()%>/user/mySpace"><span>Mon espace</span></a></li>
			<%  if(session.getAttribute("user") != null) { %>
				<li class='has-sub'class="service"> <a href="<%=request.getContextPath()%>/user/disconnect"><span>Déconnexion</span></a></li>
			<% } %>
			<li class='last' class="service"><a href='#'><span>Contact</span></a></li>
		</ul>
	</div>
	</nav>
